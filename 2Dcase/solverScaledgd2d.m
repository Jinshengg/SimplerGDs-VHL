function [si,iter,X,ratio,mg,timer,cond,err] = ...
    solverScaledgd2d(y,B,N1,N2,r,s,maxit,trace,X0,tol_1,tol_2,tol_3,t_end,test)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Inputs 
...
% 
% %     gu1 = Zu*(Zv'*Zv) - G(X*diag(dy2),s,N1,N2)*Zv;
% %     gu2 = G(Astar(Aop(X*diag(dy2),B),B),s,N1,N2)*Zv;
